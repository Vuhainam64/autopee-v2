...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          // Ant Design rất lớn (~1MB), nhưng đây là bình thường
          // Vite sẽ tự động tree-shake và chỉ bundle những components được sử dụng
          'antd-vendor': ['antd'],
          // Tách Redux
    ...
    // Ant Design là library rất lớn (~1MB), đây là bình thường
    // Vite đã tự động tree-shake, chỉ bundle components được sử dụng
